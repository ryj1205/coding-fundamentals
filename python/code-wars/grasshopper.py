...
# creating the function. checkAlive/CheckAlive/check_alive should return true if the player's
# health is greater than 0 or false if it is 0 or below. The function receives one parameter
